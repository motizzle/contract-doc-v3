...
export const macInstallInstructions = {
  ...
  steps: [
    ...
    },
    {
      ...
      description: 'Do not worry! Mac is automatically blocking this installation so people don't install malware. This is a standard setting. When you double click the file, you will see this security warning. There is nothing we can do about it and it will not do damage. Just click 'done.',
  ...
  linkCodeSection: {
    title: 'Link with your browser via a code',
