...
echo [1/6] Closing Word (if running)...
...
echo [2/6] Checking for deployed add-in...
...
echo [3/6] Stopping any existing local sideloads...
...
echo [6/7] Preparing browser session...
...
echo [7/7] Sideloading local add-in...
